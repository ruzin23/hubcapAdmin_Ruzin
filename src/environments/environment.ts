...
export const environment = {
    ...
    new_promotion_url: 'http://localhost:8080/carwashapi/addPromotion',
    update_store_url: 'http://localhost:8080/carwashapi/updateStore',
    update_package_url: 'http://localhost:8080/carwashapi/updatePackage',
    update_package_array_url: '',
    update_promotion_url: '',
    delete_store_url: '',
    delete_package_url: 'http://localhost:8080/carwashapi/deletePackage',
